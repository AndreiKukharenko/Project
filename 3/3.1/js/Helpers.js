(function(global){
    ...
    var RoundTime = {
        round : function(time, precision){
            ...
            for(let i = 0; i< roundExecutingFunctions.length; i++){
                timeAsData = new Date(timeMS); // get the Date() object
                timeAsData = roundExecutingFunctions[i](timeAsData); // discard smallest values
    ...
    global.timeIntervalHandler = TimeIntervalHandler;
})(this);